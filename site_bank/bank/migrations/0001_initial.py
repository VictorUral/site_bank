# Generated by Django 3.2.9 on 2022-02-08 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[(' ', 'Не выбран'), ('М', 'Мужской'), ('Ж', 'Женский')], default=' ', max_length=2, verbose_name='Пол')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account', models.CharField(choices=[('USD', 'USD'), ('EUR', 'EUR'), ('RUB', 'RUB')], max_length=3, verbose_name='Счёт')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bank.bank_account')),
            ],
            options={
